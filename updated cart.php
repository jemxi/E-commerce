...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['action'])) {
        ...
        // Handle checkbox actions (select multiple items to remove/update)
        if (isset($_POST['selected_items']) && isset($_POST['action'])) {
            $selected_items = $_POST['selected_items']; // Array of selected product IDs
            if ($_POST['action'] === 'remove') {
        ...
        <form action="cart.php" method="POST">
            ...
            <div class="mt-8 flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="text-right">
                    ...
                    <button type="submit" name="action" value="remove" class="bg-red-600 text-white px-6 py-2 rounded-full hover:bg-red-700 transition duration-300 mt-4 md:mt-0">Remove Selected</button>
                </div>
            </div>
        </form>
    <?php endif; ?>
