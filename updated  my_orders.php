...
<!-- Cancel Reason Modal -->
<div id="cancel-reason-modal" class="hidden fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-lg p-6 w-96">
        ...
        <form id="cancel-reason-form">
            ...
            <div class="mb-4">
                <label class="block mb-2 text-gray-700 font-semibold">Reason:</label>
                <select id="cancel-reason" class="w-full border border-gray-300 rounded-lg p-2">
                    <option value="">Select a reason</option>
                    <option value="wrong_address">I need to change Name</option>
                    <option value="wrong_number">I need to change Phone Number</option>
                    <option value="wrong_email">I need to change Email Address</option>
                    <option value="changed_mind">I need to change Address</option>
                    <option value="others">Others</option>
                </select>
            </div>
            <div class="flex justify-end">
                <button type="button" class="bg-gray-500 text-white px-4 py-2 rounded mr-2" onclick="closeCancelModal()">Cancel</button>
    ...
    <script>
        ...
        function cancelOrder(orderId) {
    // Ipakita ang modal at itakda ang order ID
